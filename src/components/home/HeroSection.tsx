...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-accent-primary/10 rounded-full blur-[120px]" />
      <div className="absolute top-20 right-0 w-[400px] h-[400px] bg-accent-secondary/5 rounded-full blur-[100px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="max-w-xl mx-auto mb-12">
            <div className="flex items-center gap-3 bg-background-card rounded-xl border border-border px-4 py-3 focus-within:border-accent-primary/50 transition-colors">
              ...
              />
              <Link
                href={searchQuery ? `/recherche?q=${encodeURIComponent(searchQuery)}` : "/casinos"}
